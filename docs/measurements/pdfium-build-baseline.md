...
- Static output directory:
  `/private/tmp/pdfrust-tools/pdfium-work/pdfium/out/pdfrust-thumb`
- Runtime dylib output directory:
  `/private/tmp/pdfrust-tools/pdfium-work/pdfium/out/pdfrust-dylib`
- Runtime library:
...
Run from `/private/tmp/pdfrust-tools/pdfium-work/pdfium` after the checkout and
`gclient sync --nohooks && gclient runhooks`.

```sh
gn gen out/pdfrust-thumb --args='is_debug = false is_component_build = false pdf_enable_v8 = false pdf_enable_xfa = false pdf_use_skia = false pdf_use_agg = true pdf_is_standalone = false pdf_is_complete_lib = true clang_use_chrome_plugins = false use_remoteexec = false treat_warnings_as_errors = false'
ninja -C out/pdfrust-thumb pdfium

gn gen out/pdfrust-dylib --args='is_debug = false is_component_build = true pdf_enable_v8 = false pdf_enable_xfa = false pdf_use_skia = false pdf_use_agg = true pdf_is_standalone = false pdf_is_complete_lib = false clang_use_chrome_plugins = false use_remoteexec = false treat_warnings_as_errors = false'
...
```sh
/usr/bin/time -l target/release/pdfrust-cli \
  render fixtures/generated/text-page.pdf \
  --output target/pdfrust-thumbnails/text-page-256.png \
  --max-edge 256
```
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 256 | `target/pdfrust-thumbnails/text-page-256.png` | 256x137 | 137K | `1711931704d73467a89f35f4ff523dabecd3b1bf4f4716924e350c4dfc957593` | `2cd4dbfeb05110c7c67e5ae7bf6f2f6c0a9cc240bf69aa5f0acd902426ff31b8` | 0.04s real, 0.01s user, 0.02s sys | 24,313,856 bytes |
| 512 | `target/pdfrust-thumbnails/text-page-512.png` | 300x160 | 188K | `f4a6974feabbd0beb894ca40733498da3a623518bc5f26557df2cf83cee923e0` | `2d01856844de307026a2f727d900314810b7df746463e991909ec148900a8897` | 0.03s real, 0.01s user, 0.02s sys | 24,674,304 bytes |
| 1024 | `target/pdfrust-thumbnails/text-page-1024.png` | 300x160 | 188K | `f4a6974feabbd0beb894ca40733498da3a623518bc5f26557df2cf83cee923e0` | `2d01856844de307026a2f727d900314810b7df746463e991909ec148900a8897` | 0.03s real, 0.01s user, 0.02s sys | 24,625,152 bytes |
