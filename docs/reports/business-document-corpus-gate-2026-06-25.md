...
```text
cargo fmt --check
git diff --check -- crates/ferrugo-cli/src/main.rs crates/ferrugo-native/src/lib.rs fixtures/corpus-manifest.tsv fixtures/business-document-manifest.tsv scripts/generate_fixtures.py
cargo check --workspace
cargo test -p ferrugo-cli benchmark_config -- --nocapture
