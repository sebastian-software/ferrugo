...
```text
cargo fmt --check
git diff --check -- crates/pdfrust-native/src/lib.rs fixtures/corpus-manifest.tsv fixtures/spreadsheet-grid-manifest.tsv scripts/generate_fixtures.py
cargo check --workspace
cargo test -p pdfrust-native spreadsheet_grid -- --nocapture
